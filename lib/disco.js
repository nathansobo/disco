...
$.extend(Disco.Model, {
  ...
  extend_constructor: function(resource_url, constructor) {
    ...
    $.extend(constructor, {
      ...
      has_many_through: function(association_name, through_association_name) {
      ...
      has_one: function(association_name) {
        this.has_one_associations.push(association_name);
      },

      belongs_to: function(association_name) {
        this.belongs_to_associations.push(association_name);
      },
      ...
      attach_has_many_association: function(object, association_name) {
        var associated_constructor = this.associated_constructor(association_name, true);
      ...
      attach_has_many_through_association: function(object, association_info) {
        ...
        var source_name = association_name.singularize();
        object[association_name] = function() {
          return this[through_association_name]().collect(function(join_model) {
            return join_model[source_name]();
          });
        }
      },

      attach_has_one_association: function(object, association_name) {
        var associated_constructor = this.associated_constructor(association_name, false);
        var conditions = this.foreign_key_conditions(object);
        object[association_name] = function() {
      ...
      attach_belongs_to_association: function(object, association_name) {
        var associated_constructor = this.associated_constructor(association_name, false);
      ...
      associated_constructor: function(association_name, name_is_plural) {
        if (name_is_plural) {
          var associated_constructor_name = association_name.singularize().camelize();
        } else {
          var associated_constructor_name = association_name.camelize();
        }
        var associated_constructor = Disco.Model.constructors[associated_constructor_name];
